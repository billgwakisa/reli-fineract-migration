...
let CorsMiddleware = class CorsMiddleware {
    constructor(configService) {
        ...
        this.allowOrigin = this.configService.get('middleware.cors.allowOrigin');
        this.allowMethod = this.configService.get('middleware.cors.allowMethod');
        this.allowHeader = this.configService.get('middleware.cors.allowHeader');
    }
    use(req, res, next) {
