...
import { IAwsS3PutItem, IAwsS3PutItemOptions, IAwsS3PutItemWithAclOptions } from 'src/common/aws/interfaces/aws.interface';
...
export interface IAwsS3Service {
    ...
    uploadPart(multipart: AwsS3MultipartDto, partNumber: number, content: UploadPartRequest['Body'] | string | Uint8Array | Buffer): Promise<AwsS3MultipartPartDto>;
