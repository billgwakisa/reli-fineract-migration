...
export interface IFileUploadMultipleField extends Omit<IFileUploadMultiple, 'fileSize'> {
}
export interface IFileUploadMultipleFieldOptions extends Pick<IFileUploadSingle, 'fileSize'> {
}
