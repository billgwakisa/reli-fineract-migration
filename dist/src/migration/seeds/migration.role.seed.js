...
let MigrationRoleSeed = class MigrationRoleSeed {
    ...
    async seeds() {
        const dataAdmin = [
            {
                name: 'superadmin',
                type: policy_enum_constant_1.ENUM_POLICY_ROLE_TYPE.SUPER_ADMIN,
                permissions: [],
            },
            {
                name: 'admin',
                type: policy_enum_constant_1.ENUM_POLICY_ROLE_TYPE.ADMIN,
            ...
            {
                name: 'member',
                type: policy_enum_constant_1.ENUM_POLICY_ROLE_TYPE.USER,
                permissions: [
                    {
