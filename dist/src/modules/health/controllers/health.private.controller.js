...
exports.HealthPrivateController = void 0;
...
let HealthPrivateController = class HealthPrivateController {
...
exports.HealthPrivateController = HealthPrivateController;
__decorate([
    (0, health_doc_1.HealthCheckDoc)(),
    (0, response_decorator_1.Response)('health.check'),
...
], HealthPrivateController.prototype, "checkAws", null);
__decorate([
    (0, health_doc_1.HealthCheckDoc)(),
    (0, response_decorator_1.Response)('health.check'),
    (0, terminus_1.HealthCheck)(),
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], HealthPrivateController.prototype, "checkDatabase", null);
__decorate([
    (0, health_doc_1.HealthCheckDoc)(),
    (0, response_decorator_1.Response)('health.check'),
    (0, terminus_1.HealthCheck)(),
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], HealthPrivateController.prototype, "checkMemoryHeap", null);
__decorate([
    (0, health_doc_1.HealthCheckDoc)(),
    (0, response_decorator_1.Response)('health.check'),
    (0, terminus_1.HealthCheck)(),
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], HealthPrivateController.prototype, "checkMemoryRss", null);
__decorate([
    (0, health_doc_1.HealthCheckDoc)(),
    (0, response_decorator_1.Response)('health.check'),
    (0, terminus_1.HealthCheck)(),
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], HealthPrivateController.prototype, "checkStorage", null);
exports.HealthPrivateController = HealthPrivateController = __decorate([
    (0, swagger_1.ApiTags)('modules.private.health'),
...
//# sourceMappingURL=health.private.controller.js.map